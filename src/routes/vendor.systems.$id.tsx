...
const getSystem = createServerFn({ method: "GET" }).handler(
...
export const Route = createFileRoute("/vendor/systems/$id")({
  loader: async ({ params }) => {
    const system = await getSystem({ data: { id: params.id } });
          ...
          <Card>
            <CardContent className="pt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <Input defaultValue={system.category} />
              </div>
              <div className="sm:col-span-2">
                <Label>Tagline</Label>
                <Input defaultValue={system.tagline} />
              </div>
              <div className="sm:col-span-2">
                <Label>Description</Label>
                <Textarea rows={6} defaultValue={system.description} />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="pt-6">
              ...
              <div className="grid gap-3 sm:grid-cols-4 mt-4">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="aspect-video rounded-md bg-secondary" />
                ))}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6 grid gap-4">
              ...
              <div>
                ...
                <Input defaultValue={`${system.name} — ${system.vendor}`} />
              </div>
              <div>
