    ...
    <SafeAreaView style={[styles.root, { backgroundColor: theme.background }]}>
      ...
      {error ? (
        <View style={styles.empty}>
          ...
          <Pressable onPress={() => router.push('/auth/login')} style={[styles.browseBtn, { backgroundColor: theme.primary }]}>
        ...
        <View style={styles.empty}>
          ...
          <Pressable onPress={() => router.push('/')} style={[styles.browseBtn, { backgroundColor: theme.primary }]}>
            <Text style={[styles.browseBtnText, { color: theme.primaryForeground }]}>Browse systems</Text>
          </Pressable>
        </View>
      ) : (
        <FlatList
            ...
            >
              <View style={styles.cardTop}>
                <View style={styles.meta}>
                  ...
                  <Text style={[styles.vendor, { color: theme.mutedForeground }]}>{item.vendor_name}</Text>
                </View>
                <Text style={[styles.price, { color: theme.text }]}>{item.starting_price}</Text>
              </View>
              <View style={styles.actions}>
                <Pressable onPress={() => remove(item.id)} style={[styles.actionBtn, { borderColor: theme.border }]}>
...
const styles = StyleSheet.create({
  ...
  browseBtn: { marginTop: Spacing.md, paddingHorizontal: Spacing.lg, paddingVertical: Spacing.sm, borderRadius: Radius.md },
  ...
  actionBtn: { flex: 1, borderWidth: 1, borderRadius: Radius.md, paddingVertical: Spacing.sm, alignItems: 'center' },
});
