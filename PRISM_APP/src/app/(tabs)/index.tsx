...
export default function DiscoverScreen() {
  ...
  const {
    ...
    error: systemsError,
  } = useApi(() => api.systems.list(systemsParams as Record<string, string>), [systemsParams]);
          ...
          return (
            ...
            >
              <Text
                style={[
                  styles.catLabel,
                  { color: active ? theme.primaryForeground : theme.chipText },
                ]}
              >
                {cat}
              </Text>
    ...
    >
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardMeta}>
          ...
          <Text style={[styles.cardVendor, { color: theme.mutedForeground }]}>
            {item.vendor_name}
          </Text>
        </View>
      ...
      <View style={styles.badgeRow}>
        ...
        {item.verified && <Badge label="✓ Verified" color={theme.verified} bg={theme.verifiedBg} />}
